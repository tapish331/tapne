...
class ChangedPixelRatioTests(unittest.TestCase):
    def test_identical_images_have_zero_diff_ratio(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            p1 = Path(tmp) / "a.png"
            p2 = Path(tmp) / "b.png"
            Image.new("RGBA", (20, 10), (20, 40, 60, 255)).save(p1)
            Image.new("RGBA", (20, 10), (20, 40, 60, 255)).save(p2)
    ...
    def test_size_mismatch_returns_full_diff_ratio(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            p2 = Path(tmp) / "b.png"
            Image.new("RGBA", (20, 10), (20, 40, 60, 255)).save(p1)
            Image.new("RGBA", (10, 20), (20, 40, 60, 255)).save(p2)
            ratio, reason = MODULE.changed_pixel_ratio(p1, p2)
    ...
    def test_one_pixel_change_reports_non_zero_ratio(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            p1 = Path(tmp) / "a.png"
            p2 = Path(tmp) / "b.png"
            img_a = Image.new("RGBA", (20, 10), (20, 40, 60, 255))
            img_b = Image.new("RGBA", (20, 10), (20, 40, 60, 255))
