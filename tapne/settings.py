...
TAPNE_TRIP_DESTINATION_PROXY_TIMEOUT_SECONDS = max(1, env_int("TAPNE_TRIP_DESTINATION_PROXY_TIMEOUT_SECONDS", 5))
TAPNE_TRIP_DESTINATION_AUTOCOMPLETE_LIMIT = max(
    1,
    min(10, env_int("TAPNE_TRIP_DESTINATION_AUTOCOMPLETE_LIMIT", 6)),
)
TAPNE_TRIP_DESTINATION_AUTOCOMPLETE_CACHE_TTL_SECONDS = max(
    0,
    env_int("TAPNE_TRIP_DESTINATION_AUTOCOMPLETE_CACHE_TTL_SECONDS", 120),
)
TAPNE_TRIP_DESTINATION_DETAILS_CACHE_TTL_SECONDS = max(
    0,
    env_int("TAPNE_TRIP_DESTINATION_DETAILS_CACHE_TTL_SECONDS", 86_400),
)
TAPNE_TRIP_DESTINATION_RATE_LIMIT_WINDOW_SECONDS = max(
    1,
    env_int("TAPNE_TRIP_DESTINATION_RATE_LIMIT_WINDOW_SECONDS", 60),
)
TAPNE_TRIP_DESTINATION_AUTOCOMPLETE_RATE_LIMIT_REQUESTS = max(
    1,
    env_int("TAPNE_TRIP_DESTINATION_AUTOCOMPLETE_RATE_LIMIT_REQUESTS", 90),
)
TAPNE_TRIP_DESTINATION_DETAILS_RATE_LIMIT_REQUESTS = max(
    1,
    env_int("TAPNE_TRIP_DESTINATION_DETAILS_RATE_LIMIT_REQUESTS", 45),
)

DEFAULT_AUTO_FIELD = "django.db.models.BigAutoField"

# Email — defaults to console output in dev, configure SMTP vars for production.
